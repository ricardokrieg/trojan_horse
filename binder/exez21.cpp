...
int main(int argc, char *argv[])
{
    ...
    {
        cout << "Format your input as:\nExez21.exe [file1.exe] [file2.exe] -o [output.exe]\n[file1.exe]: sourcefile 1\n[file2.exe]: sourcefile 2\n-o: output\n[output.exe]: outputfile\n";
        return 0;
    }
    else
    {
...
bool Bind(char *args[5])
{
    ...
    {
        cout << "Error file endings must be .exe\n";
        return false;
    }
...
// i586-mingw32msvc-g++ -o binder.exe exez21.cpp openall.cpp
